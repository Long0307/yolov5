...
class Segment(Detect):
    ...
    def __init__(self, nc=1, anchors=(), nm=32, npr=256, ch=(), inplace=True):
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                ...
                BottleneckCSP, C3, C3TR, C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, BasicBlock}:
            c1, c2 = ch[f], args[0]
