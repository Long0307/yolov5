...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from yolov5.models.resnet.commonă import AutoShape, DetectMultiBackend
    from models.experimental import attempt_load
    from yolov5.models.resnet.yolov5s import ClassificationModel, DetectionModel, SegmentationModel
