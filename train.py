...
try:
    ...
    experiment = Experiment(
        ...
        api_key="DnzKIkMVKUnvpesQ9U4Aca76F"
    )

    comet_ml.init(api_key="DnzKIkMVKUnvpesQ9U4Aca76F")
    # comet_ml.config.save(api_key="DnzKIkMVKUnvpesQ9U4Aca76F")
except ImportError:
    comet_ml = None
...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "yolov5s_best.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="models/BiFPNConcat.yaml", help="model.yaml path")
