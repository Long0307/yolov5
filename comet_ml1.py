...
train_dataset = dsets.MNIST(
    root="./datasets/coco128/images/train2017", train=True, transform=transforms.ToTensor(), download=True
)

test_dataset = dsets.MNIST(root="./datasets/coco128/images/train2017", train=False, transform=transforms.ToTensor())
